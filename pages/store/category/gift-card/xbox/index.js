...
export default function XboxGiftCard() {
    ...
    const BASE_QUERY = "api/gift-cards?filters[platform][$eq]=xbox";
    ...
    return (
        <div className="px-4 md:px-10 py-8">
            ...
            <section className="relative w-full h-[450px] overflow-hidden rounded-xl mb-10">
                {/* Background image */}
                <Image
                    src="https://res.cloudinary.com/dblttl9bh/image/upload/e_blur:1000,q_1,w_50/v1767511454/Xbox_Gift_Cards_Instant_Digital_Delivery_1_13fdcc7175.png"
                    alt="Xbox Banner"
                    fill
                    priority
                ...
                <Image
                    ...
                    // blurDataURL='https://res.cloudinary.com/dblttl9bh/image/upload/e_blur:1000,q_1,w_50/v1781011315/b6919f4f-4679-4c15-9d8a-834471b9d401_psn-bannerwebp_gldvuc.webp'
                    // alt={title}
                    fill
